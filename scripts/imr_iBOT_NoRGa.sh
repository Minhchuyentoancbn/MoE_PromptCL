...
--output_dir ./output/NoRGa_imr_ibot_covariance_mlp_2_seed$seed \
--seed $seed \
...
--ca_lr 0.005 \
--crct_epochs 80 --epochs 50 \
--prompt_momentum 0.01 --length 20 \
--reg 0.5 \
--sched constant --larger_prompt_lr \
--ca_storage_efficient_method covariance \
--trained_original_model ./output/NoRGa_imr_ibot_covariance_mlp_2_seed$seed \
--output_dir ./output/NoRGa_imr_ibot_pe_seed$seed \
