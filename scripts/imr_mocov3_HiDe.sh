...
--output_dir ./output/HiDe_imr_mocov3_covariance_mlp_2_seed$seed \
--seed $seed \
...
--ca_storage_efficient_method covariance \
--trained_original_model ./output/HiDe_imr_mocov3_covariance_mlp_2_seed$seed \
--output_dir ./output/HiDe_imr_mocov3_pe_seed$seed \
--shuffle True --reset
done