...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--lr', type=float, default=0.005, metavar='LR', help='learning rate (default: 0.005)')
    ...
    subparsers.add_argument('--g_prompt_length', default=10, type=int, help='length of G-Prompt')
